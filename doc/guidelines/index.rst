...
==========================================
Guidelines for creating pyqi-based scripts
==========================================

This document covers some general suggestions for designing command line interfaces with pyqi. Ideally this document will evolve with time, so if you have suggestions for things that should be included, please consider submitting them as a `pull request <https://help.github.com/articles/using-pull-requests>`_.  
